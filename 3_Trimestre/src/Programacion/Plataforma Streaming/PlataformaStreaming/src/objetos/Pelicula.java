...
public class Pelicula {
    ...
    public String toString() {
        return "Pelicula [id=" + id + ", titulo=" + titulo + ", genero=" + genero + ", anyoLanzamiento="
                + anyoLanzamiento + ", calificacion=" + calificacion + ", numeroTemporada=" + numeroTemporada
                + ", edadRecomendada=" + edadRecomendada + ", duracion=" + duracion + "]";
    }
}
